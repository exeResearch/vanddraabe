...
rmarkdown::html_vignette:
  ...
  fig_retina: yes
vignette: |
  %\VignetteIndexEntry{vanddraabe: Thrombin Conserved Waters Analysis} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
---
...
```{r Bvalue summary barplot, echo=FALSE, fig.retina=1, fig.align='center', message=FALSE, warning=FALSE}
...
```{r norm Bvalue summary barplot, echo=FALSE, fig.retina=1, fig.align='center', message=FALSE, warning=FALSE}
...
```{r occupancy summary barplot, echo=FALSE, fig.retina=1, fig.align='center', message=FALSE, warning=FALSE}
...
```{r mobility summary barplot, echo=FALSE, fig.retina=1, fig.align='center', message=FALSE, warning=FALSE}
...
```{r align sequences, eval=FALSE, message=FALSE, warning=FALSE, include=TRUE}
...
```{r structural alignment quality (display difference histogram), echo=FALSE, fig.retina=1, fig.cap="Histogram of Absolute RMSD Differences (RMSD fit - RMSD No Fit)"}
...
- **_PDBid__AliOver**: The results from the [AlignOverlap()] analysis. The reference structure is the PDBid in the sheet name and is indicated within the results. The chains meeting the user defined parameters are retained and written to a new PDB file for each structure.
...
```{r conserved waters: conservation plot, echo=TRUE, fig.retina=1, message=FALSE, warning=FALSE}
...
```{r conserved waters: occupancy barplots, echo=TRUE, fig.retina=1, message=FALSE, warning=FALSE}
...
```{r conserved waters: mobility barplots, echo=TRUE, fig.retina=1, message=FALSE, warning=FALSE}
...
```{r conserved waters: experimental Bvalue barplots, echo=TRUE, fig.retina=1, message=FALSE, warning=FALSE}
BvalueBarplot(data = thrombin10.conservedWaters, passed.waters = TRUE, calc.values = FALSE)
```

```{r conserved waters: calculated Bvalue barplots, echo=TRUE, fig.retina=1, message=FALSE, warning=FALSE}
...
```{r conserved waters: nBvalue barplots, echo=TRUE, fig.retina=1, message=FALSE, warning=FALSE}
...
```{r Mobility and Normalized B-values Evaluation Plots, echo=TRUE, fig.retina=1, message=FALSE, warning=FALSE}
...
```{r Bound Water Environment Barplots, echo=TRUE, fig.retina=1, message=FALSE, warning=FALSE}
...
```{r Bound Water Environment Summary Plot, echo=TRUE, fig.retina=1, message=FALSE, warning=FALSE}
